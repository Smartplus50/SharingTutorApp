...
public class TrainersController {
	...
	private TrainersService trainersService;
	 ...
	 public List<Trainers> getTrainerssByName(@PathVariable String name) {
	 	return trainersService.getTrainerssByName(name);
	 }	

	  
	 @RequestMapping(value = "/Trainers/degree/{degree}")
	 public List<Trainers> getTrainerssByDegree(@PathVariable String degree) {
	 	return trainersService.getTrainerssByDegree(degree);
	 }	

	 @RequestMapping(value = "/Trainers/session/{session}")
	 public List<Trainers> getTrainerssBysession(@PathVariable String session) {
	 	return trainersService.getTrainerssBysession(session);
	 }	
